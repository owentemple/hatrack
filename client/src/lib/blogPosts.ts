...
<p>You can set your why for any hat after completing a session. It&rsquo;s available now for <a href="/settings">HatRack Premium</a> subscribers. And if you don&rsquo;t have anything to write yet, that&rsquo;s fine. The question will be there the next time you show up.</p>`,
  },
  {
    ...
    date: '2026-03-14',
    body: `<p>HatRack has had a premium tier since 2015. Back then, &ldquo;premium&rdquo; meant your hats were saved. You&rsquo;d enter your daily, weekly, and monthly priorities, pay $5 through PayPal, and they&rsquo;d be stored and waiting for you the next time you opened the app. If you didn&rsquo;t pay, you re-entered them every day.</p>
...
<p>You already know how to meditate. You already know how to read and stretch and practice. The only thing left is to <a href="https://www.hatrack.it/">start</a>.</p>`,
  ...
  {
    slug: 'you-have-twenty-minutes',
    title: 'You Have Twenty Minutes. What Do You Work On?',
    subtitle: 'Why the hardest part of doing what matters is deciding to start',
    date: '2026-03-10',
    body: `<p>You finally have a free window. Twenty minutes, maybe thirty. The kids are occupied or the meeting ended early or you just woke up before your alarm.</p>
...
<p>Sometimes the elephant just needs someone to point at the path.</p>`,
  ...
  {
    slug: 'the-hats-you-wear',
    title: 'The Hats You Wear',
    subtitle: 'Why recurring activities need a different kind of tool',
    date: '2016-07-07',
    body: `<p>For most of us, life and work require wearing multiple hats. There are multiple roles or task categories we need to perform on a daily basis.</p>
...
<p>Every hat gets its turn. Nothing gets neglected. And you stop spending your limited energy on the meta-work of choosing, scheduling, and prioritizing &mdash; so you can spend it on the work itself.</p>`,
  ...
  {
    slug: 'fifty-words-one-song-one-chord-two-pages',
    title: 'Fifty Words, One Song, One Chord, Two Pages',
    subtitle: 'The case for making your goals embarrassingly small',
    date: '2016-01-09',
    body: `<p>When I set up my first HatRack, I made each micro goal embarrassingly small.</p>
...
<p>The micro goals have changed over the years. The principle hasn&rsquo;t. Make it small enough that you can&rsquo;t say no.</p>`,
  ...
  {
    slug: 'wear-many-hats-make-a-habit',
    title: 'Wear Many Hats, Make a Habit, Build a Dream',
    subtitle: 'How a songwriter\'s problem became a productivity app',
    date: '2015-09-08',
    body: `<p>I built HatRack because I couldn&rsquo;t stop dropping hats.</p>
...
<p>An app to help you wear many hats, make a habit, and build a dream.</p>`,
  ...
  {
    slug: 'hatrack-in-your-pocket',
    title: 'HatRack in Your Pocket',
    subtitle: 'Taking the hatrack mobile',
    date: '2016-06-28',
    body: `<p>The first version of HatRack lived at hatrackapp.com &mdash; a set of HTML pages with jQuery and draggable tokens. It worked on a laptop. On a phone, it was unusable. The tokens were too small to drag. The images didn&rsquo;t scale. The timer was a link to someone else&rsquo;s website that opened in a popup window.</p>
