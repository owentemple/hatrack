...
if (process.env.NODE_ENV === 'production') {
  ...
  const preRendered: Record<string, string> = {
    ...
    '/about': shell(publicNav, `
      <div class="about-page">
        ...
        <div class="about-blog-feature">
          <h3>From the Blog</h3>
          <a href="/blog/the-productivity-trap" class="blog-card">
            <h3>The Productivity Trap (and the Tool That Doesn&rsquo;t Set It)</h3>
            <p class="blog-card-subtitle">Why the best productivity hack might be doing less, not faster.</p>
          </a>
      ...
      <div class="blog-page">
        ...
        <div class="blog-list">
          <a href="/blog/the-productivity-trap" class="blog-card">
            <h3>The Productivity Trap (and the Tool That Doesn&rsquo;t Set It)</h3>
            <p class="blog-card-subtitle">Why the best productivity hack might be doing less, not faster.</p>
            <span class="blog-card-date">March 24, 2026</span>
          </a>
    ...
    '/blog/the-productivity-trap': shell(publicNav, `
      <div class="blog-page">
        <a href="/blog" class="back-link">&larr; Back to Blog</a>
        <article class="blog-article">
          <h2>The Productivity Trap (and the Tool That Doesn&rsquo;t Set It)</h2>
          <p class="blog-subtitle">Why the best productivity hack might be doing less, not faster.</p>
          <p class="blog-date">March 24, 2026</p>
          <div class="blog-body">
            <p>Every new tool promises to make work easier. Email. Slack. Smart assistants. The pitch is always the same: automate the boring stuff, and you&rsquo;ll have more time for what matters.</p>
