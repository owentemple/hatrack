  ...
  const preRendered: Record<string, string> = {
    ...
    '/about': shell(publicNav, `
      <div class="about-page">
        ...
        <h3 style="margin-top:24px;font-size:0.95rem">Subscriptions</h3>
        <p style="font-size:0.85rem">HatRack is free to use. HatRack Premium unlocks stats, streak calendar, and insights for $5/month. Cancel anytime from Settings &mdash; your premium features remain active through the end of your billing period. No refunds for partial billing periods. Questions? Contact <a href="mailto:info@hatrackapp.com">info@hatrackapp.com</a>.</p>
